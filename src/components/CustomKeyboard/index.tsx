...
class CustomKeyboard extends React.Component<IProps, IState> {
  ...
  render() {
    ...
    return (
      <View style={[styles.touchPad,{backgroundColor:theme.PRIMARY_BACKGROUND_COLOR}]}>
        {
              ...
              <TouchableOpacity
                ...
                style={styles.touchPadButton}>
                {
                  ...
                  // <View style = { { backgroundColor:d !== '10'  ? '#FFF' : colors.darkOrange , padding:5 ,borderRadius:140 ,width:'40%' ,alignContent:'center' ,alignItems:'center'}}>
                    <Text style={[styles.touchpadText,{color:theme.PRIMARY_TEXT_COLOR}]}>{d}</Text>
                  // </View>
                    : < MIcon name={'window-close'} size={scale(25)} color={colors.grayBorder} />
                }
              </TouchableOpacity>
            );
          })
